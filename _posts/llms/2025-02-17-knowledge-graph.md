...
| **Applications**   | Social Nw analysis: Predict user behavior, friend recommendations
                       Molecule property prediction: For drug discovery (moledules as graphs)                                                                    | Entity linking, semantic search, recommendation                                           |
